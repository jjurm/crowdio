...
import com.treecio.crowdio.NotificationBuilder
...
class FirebaseMessagingService : FirebaseMessagingService() {
    ...
    companion object {
        private const val KEY_EVENT = "type"
    ...
    private fun newPerformance(data: Map<String, String>) {
        ...
        DataHolder.updateSinglePerformance(performance)

        if (!DataHolder.submittedPerformanes.contains(performance.id)) {
            NotificationBuilder(this).performanceNearby(performance)
        }
    }
